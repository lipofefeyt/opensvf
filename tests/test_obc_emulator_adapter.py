...
def make_adapter(**kwargs) -> OBCEmulatorAdapter:
...
class OBCEmulatorAdapterTests:
    ...
    def test_ports_match_obc_equipment(self):
    ...
    def test_missing_sim_raises(self):
    ...
    def test_initialise_spawns_process(self):
    ...
    def test_do_step_receives_sync_byte(self):
    ...
    def test_on_tick_calls_publish_ready(self):
    ...
    def test_mode_cmd_sends_recover_tc(self):
    ...
    def test_obt_advances_each_tick(self):
